        ...
        <div className="container">
            <div className="row">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="post-entry-1">
                                <Link to="post-single.html">
                                    <img src="images/img_h_1.jpg" alt="Image" className="img-fluid" /></Link>
                                <h2><Link to="blog-single.html">News Needs to Meet Its Audiences Where They Are</Link> </h2>
                        ...
                        <div className="col-md-6">
                            <div className="post-entry-2 d-flex bg-light">
                                <div className="thumbnail" style={{backgroundImage: 'url(images/img_v_1.jpg)'}}>div</div>
                                <div className="contents">
                                    <h2><Link to="blog-single.html">News Needs to Meet Its Audiences Where They Are</Link>
                                    </h2>
                                    <div className="post-meta">
                                        <span className="d-block"><Link to="#">Dave Rogers</Link>  in <Link
                                            to="#">News</Link> </span>
                            ...
                            <div className="post-entry-2 d-flex">
                                <div className="thumbnail" style={{backgroundImage: 'url(images/img_v_2.jpg)'}}>div</div>
                                <div className="contents">
                                    <h2><Link to="blog-single.html">News Needs to Meet Its Audiences Where They Are</Link>
                                    </h2>
                                    <div className="post-meta">
                            ...
                            <div className="post-entry-2 d-flex">
                                <div className="thumbnail" style={{backgroundImage: 'url(images/img_v_3.jpg)'}}>div</div>
                                <div className="contents">
                                    <h2><Link to="blog-single.html">News Needs to Meet Its Audiences Where They Are</Link>
                                    </h2>
                                    <div className="post-meta">
                ...
                <div className="col-lg-4">
                    ...
                    <p>
                        <Link to="#" className="more">See All Trends <span className="icon-keyboard_arrow_right">span</span></Link>
                    </p>
